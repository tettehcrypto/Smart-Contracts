...
contract Token is ERC20, Ownable {
    ...
    function setTaxes(uint8[3] calldata taxes) external onlyOwner{
        buyTax = taxes[0];
        devTax = taxes[1];
    ...
    function setWhitelist(address account, bool exempt) public onlyOwner {
        _isWhitelisted[account] = exempt;
    }
